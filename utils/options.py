...
def get_basic_parser():
    ...
    # log related
    parser.add_argument('--save_root', type=str, default='./save/', help='save root path')
    parser.add_argument('--test_freq', type=int, default=1, help='how often to test on val set')
    parser.add_argument('--base_dir', type=str, default='',
                        help='it will be set after wandb have generated the experiment name, it seems like [save_root]/[experiemnt_name]')
    ...
    parser.add_argument('--bs_test', type=int, default=2000, help="test batch size")
    parser.add_argument('--data_frac', type=float, default=1.0, help='the fraction of used data')
    ...
    if hostname.startswith('xuyc-Server'):
        parser.set_defaults(save_root='/home/xuyc/save/')
    elif hostname.startswith('amax'):
        parser.set_defaults(save_root='/data/xuyc/save/')
...
def add_fl_parser(parser: argparse.ArgumentParser):
    ...
    # data related
    parser.add_argument('--split', type=str, default='mix', help="train-test split type, user or sample")
    parser.add_argument('--clsnum_peruser', type=int, default=2, help="the numbers of class belonged to each user.")
    
    parser.add_argument('--iid_frac', type=float, default=0.3, help="the fraction of iid users")
